...
public class Creating_Question {
    ...
    public static int[] createEasy() {
        ...
        switch (number) {
            case 1:
                question[4] = question[0] + question[1] + question[2] + question[3];  // 足し算
                break;
            case 2:
                question[4] = question[0] - question[1] - question[2] - question[3];  // 引き算
                break;
            case 3:
                question[4] = question[0] * question[1];  // 掛け算
                break;
            case 4:
                if (question[1] != 0) {
                    question[4] = question[0] / question[1];  // 割り算
                } else {
                    question[4] = 0; // 0除算回避
                }
                break;
            case 5:
                question[4] = question[0] + question[1] * question[2];  // 足し算 + 掛け算
                break;
            case 6:
                question[4] = question[0] * question[1] + question[2];  // 掛け算 + 足し算
                break;
        }
    ...
    public static int[] createNormal() {
        ...
        switch (number) {
            case 1:
                question[4] = question[0] * question[3] + question[1] - question[2] + question[2];
                break;
            case 2:
            ...
            switch (number) {
                case 1:
                    if (question[1] != 0 && question[0] % question[1] == 0) {
                        question[4] = question[0] / question[1] + question[2] * question[3];  // 割り算 + 掛け算
                        validAnswer = true;
                    }
                    break;
                case 2:
                    if (question[2] != 0 && question[1] % question[2] == 0) {
                        question[4] = question[0] * question[1] - question[2] / question[1];  // 掛け算 + 割り算
                        validAnswer = true;
                    }
                    break;
                case 3:
                    if (question[3] != 0 && question[0] % question[3] == 0) {
                        question[4] = question[0] / question[3] + question[2] * question[1];  // 割り算 + 掛け算
                        validAnswer = true;
                    }
                    break;
                case 4:
                    if (question[1] != 0 && question[0] % question[1] == 0) {
                        question[4] = question[2] * question[1] + question[3] / question[0];  // 掛け算 + 割り算
                        validAnswer = true;
                    }
                    break;
                case 5:
                    if (question[2] != 0 && question[1] % question[2] == 0) {
                        question[4] = question[1] * question[0] - question[2] / question[3];  // 掛け算 + 割り算
                        validAnswer = true;
                    }
                    break;
                case 6:
                    if (question[3] != 0 && question[2] % question[3] == 0) {
                        question[4] = question[0] + question[1] * question[2] / question[3];  // 足し算 + 割り算
                        validAnswer = true;
                    }
                    break;
            }
